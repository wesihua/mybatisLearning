 ...
 * @param id
 */
function editObject(url,id,type){
	window.open(url+"?id="+id+"&type="+type, "_self");
}
...
<body>
	<div class="query">
		<form action="<%=path %>/manager/menu/parentList" method="post">
			&nbsp;&nbsp;
			...
			<tbody>
				<c:forEach var="bean" items="${list}" varStatus="index">
					<tr>
						...
						<td>
							<button onclick="editObject('<%=path%>/manager/menu/editMenu','${bean.id}','0')">修改</button>&nbsp;&nbsp;&nbsp;
